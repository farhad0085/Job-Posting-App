...
class HelperMethods:
    ...
    @property
    def month_last_date(self) -> datetime.date:
        """Get current month's last day's date"""

        month_duration = calendar.monthrange(self.today.year, self.today.month)[1]
        return self.today.replace(day=month_duration)
